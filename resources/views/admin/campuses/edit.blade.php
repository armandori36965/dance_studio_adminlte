            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">編輯校區</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('admin.campuses.update', $campus) }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                   id="name" name="name" value="{{ old('name', $campus->name) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('type') is-invalid @enderror" 
                                                ...
                                                <option value="school" {{ old('type', $campus->type) === 'school' ? 'selected' : '' }}>學校</option>
                                                <option value="cram_school" {{ old('type', $campus->type) === 'cram_school' ? 'selected' : '' }}>補習班</option>
                                            </select>
                                            @error('type')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="color" class="form-control @error('color') is-invalid @enderror" 
                                                       id="color" name="color" value="{{ old('color', $campus->color) }}" 
                                                       style="width: 60px;">
                                                <input type="text" class="form-control @error('color') is-invalid @enderror" 
                                                       id="color_text" value="{{ old('color', $campus->color) }}" 
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">更新校區</button>
